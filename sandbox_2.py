...
import se3_control
import lqr_controller_1
import lqr_controller_derived
...
my_se3_control = lqr_controller_derived.lqr_controller(quad_params) #se3_control.SE3Control(quad_params)
# my_se3_control = se3_control.SE3Control(quad_params)
# my_se3_control = mpc_controller.MPCController(quad_params)
# my_se3_control = mpc_tes.MPCController(quad_params)
